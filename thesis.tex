...
\include{chapters/Introduction_to_Quantum_Computing}
\include{chapters/The_Embedding_Problem}
\include{chapters/The_Base_Pipeline}
\include{chapters/GAs_experiment}
\include{chapters/SA_experiment}
\include{chapters/Divide_et_Impera}
\include{chapters/Conclusions_future_works}

%---------APPENDICES----------%
\appendix
\include{appendices/appendix_A_hw}
\include{appendices/appendix_B_AI}
